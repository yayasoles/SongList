...
const {getAllSongs,getOneSong,createSong,getSong,updateSong,deleteSong,getSongbyGenere,getSongbyArtist,getSongbyAlbum}=require('../Controllers/songsController')
...
songRouter.route("/byTitle/:title").get(getOneSong);
